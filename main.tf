...
resource "aws_eks_cluster" "chat_eks" {
...
resource "aws_eks_node_group" "chat_eks_node_group" {
  cluster_name    = aws_eks_cluster.chat_eks.name
  node_group_name = "chat-app-nodegroup"
